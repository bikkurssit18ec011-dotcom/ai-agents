...
<section class="slide dark">
  <div class="cover-wrap">
    ...
    <div class="cover-meta">
      <div class="chip hi">3 KSFE branches already served</div>
...
<section class="slide dark">
  ...
  <div class="rule"></div>
  <p style="max-width:960px">We work with three KSFE branches — <strong
     style="color:#fff">Pettah</strong>, <strong
     style="color:#fff">Kolayad</strong> and <strong
     style="color:#fff">Mandapathinkadav</strong>. The figures below cover the
     seven campaigns run through our Meta ad account between September 2024 and
     February 2026, pulled directly from Meta Ads Manager — none of it is
     modelled or illustrative.</p>
  <div class="stats">
...
<section class="slide">
  ...
  <p class="note" style="margin-top:12px">Awareness campaigns are optimised for
    ...
    conversations started, so the result is enquiries. Mandapathinkadav work is
  ...
  <div class="two">
    <div>
      ...
      <ul style="margin-top:6px">
        <li>An existing, verifiable record with three KSFE branches</li>
